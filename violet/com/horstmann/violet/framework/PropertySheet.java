...
private String sessionId;
   /**
      ...
      @param sessionId online session's id
   */
   public PropertySheet(Object bean, Component parent, String sessionId)
   {
      this.parent = parent;
      ...
      try
      {
         ...
         for (int i = 0; i < descriptors.length; i++)
         {
            ...
            if (editor != null && descriptors[i].getName() != "id")
            {
      ...
      final PropertyDescriptor descriptor)
   {
      try
      {
         ...
         if (editor == null) return null;
          ...
          final Object value = getter.invoke(bean, new Object[] {});
         ...
         editor.addPropertyChangeListener(new
            PropertyChangeListener()
            {
               public void propertyChange(PropertyChangeEvent event)
               {
                  try
                  {
                     MultiLineString id = new MultiLineString();
                     //if(bean.getClass().toString().equals("class com.horstmann.violet.ClassNode")) {
                     if(bean instanceof ClassNode ||bean instanceof InterfaceNode ||bean instanceof PackageNode ||bean instanceof NoteNode) {
                        ...
                        for (PropertyDescriptor descriptor : info.getPropertyDescriptors()) {
                           ...
                           {
                              Method getter = descriptor.getReadMethod();
                              id = (MultiLineString)getter.invoke(bean, new Object[] {});
                           }
                        }
                     }
                     setter.invoke(bean, 
                     ...
                     fireStateChanged(new PropertyChangeEvent(bean, descriptor.getName(), id, editor.getValue()));
                  }
   ...
   */
   private void fireStateChanged(PropertyChangeEvent event)
   {
      for (int i = 0; i < changeListeners.size(); i++)
      {
         PropertyChangeListener listener = (PropertyChangeListener)changeListeners.get(i);
